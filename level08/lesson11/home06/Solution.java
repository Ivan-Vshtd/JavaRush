...
public class Solution
{
    ...
    {Human son1 = new Human("Ivan",true,28,new ArrayList<Human>());
        Human son2 = new Human("Anton",true,5,new ArrayList<Human>());
        Human doughter = new Human ("Lena",false,26,new ArrayList<Human>());
